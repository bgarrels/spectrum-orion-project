...
{$IFDEF BGRA_DRAW}
    ...
    procedure Draw(ACanvas: TCanvas; AX, AY, AIndex: integer; ADrawingStyle: TDrawingStyle;
      AImageType: TImageType; ADrawEffect: TGraphicsDrawEffect); override;
{$ENDIF}
  published
...
procedure TBGRAImageList.Draw(ACanvas: TCanvas;
  AX, AY, AIndex: integer; ADrawingStyle: TDrawingStyle;
...
begin
  ...
  FBGRA.Draw(ACanvas, AX-8, AY, False);
end;
